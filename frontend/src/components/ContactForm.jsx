 ...
 * that reuses the existing <ContactForm /> component (same fields,
 * validation, submission logic, Google Apps Script integration and
 * success message — no duplication).
 *
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* Scrollable body — hosts ONLY the reusable ContactForm */}
            <div
