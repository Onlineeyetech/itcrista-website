...
export default function ServicePageTemplate({ content: c }) {
  ...
  return (
    <main data-testid={`${slug}-page`} className="bg-[#071120] text-white">
      ...
      {/* ---------------------------- 2. WHY ---------------------------- */}
      <section data-testid={test("why")} className="relative py-8 md:py-16 bg-[#0A1525] border-y border-white/10 overflow-hidden">
      ...
      {/* ---------------------------- 3. INCLUDED ---------------------------- */}
      <section data-testid={test("included")} className="relative py-8 md:py-16 bg-[#071120] overflow-hidden">
      ...
      {/* ---------------------------- 4. PROCESS ---------------------------- */}
      <section data-testid={test("process")} className="relative py-8 md:py-16 bg-[#0A1525] border-y border-white/10 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="grid lg:grid-cols-12 gap-10 mb-14">
            <div className="lg:col-span-7">
      ...
      {/* ---------------------------- 5. STACK ---------------------------- */}
      <section data-testid={test("stack")} className="relative py-8 md:py-16 bg-[#071120] overflow-hidden">
      ...
      {/* ---------------------------- 6. FEATURES ---------------------------- */}
      <section data-testid={test("features")} className="relative py-8 md:py-16 bg-[#0A1525] border-y border-white/10 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="text-center max-w-2xl mx-auto mb-14">
      ...
      {/* ---------------------------- 7. PORTFOLIO ---------------------------- */}
      <section data-testid={test("portfolio")} className="relative py-8 md:py-16 bg-[#071120] overflow-hidden">
        <div className="absolute inset-0 bg-grid opacity-40" />
        <div className="relative max-w-7xl mx-auto px-6 md:px-10">
      ...
      {/* ---------------------------- 9. FAQ ---------------------------- */}
      <section data-testid={test("faq")} className="relative py-8 md:py-16 bg-[#071120] overflow-hidden">
        <div className="absolute inset-0 bg-grid opacity-30" />
      ...
      {/* ---------------------------- 10. FINAL CTA ---------------------------- */}
      <section data-testid={test("final-cta")} className="relative py-8 md:py-16 bg-[#071120] overflow-hidden">
...
function Testimonials({ items, slug }) {
  ...
  const test = (k) => `${slug}-${k}`;
  return (
    <section data-testid={test("testimonials")} className="relative py-8 md:py-16 bg-[#0A1525] border-y border-white/10 overflow-hidden">
